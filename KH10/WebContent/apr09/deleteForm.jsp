...
<form name = "
myform" action = "deletePro.jsp" method = "post" onSubmit-"return checkIt()">
...
<input type = "button" value = "취소" onclick = "javascript:window.location='main'"></td></tr>
 </table>
 </form>
</body>
</html>
